  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-[var(--bg)] text-[var(--text-primary)]">
      <div className="w-full max-w-md text-center space-y-6">
        ...
        <div className="p-5 rounded-2xl bg-[var(--surface)] border border-[var(--border)] shadow-xl text-left space-y-3 text-xs">
          ...
          <div className="space-y-2">
            <p className="font-bold text-[var(--text-primary)]">Submitted Channels:</p>
            <div className="p-2.5 rounded-lg bg-[var(--bg-secondary)] flex justify-between items-center">
        ...
        <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/20 space-y-2">
          <p className="text-xs font-bold text-[var(--blue)]">Demo Environment Shortcut</p>
          <button
            onClick={() => router.push('/creator/marketplace')}
            className="w-full py-2.5 rounded-lg bg-[var(--blue)] text-white font-bold text-xs hover:bg-[var(--blue-dark)] transition-all btn-interactive"
          >
