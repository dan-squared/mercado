      ...
      <div className="space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/admin/queue"
              className="px-4 py-2.5 rounded-xl bg-amber-500/10 text-amber-600 dark:text-amber-400 font-bold text-xs border border-amber-500/20 hover:bg-amber-500/20 transition-colors duration-150 flex items-center gap-1.5"
            >
            ...
            <Link
              href="/admin/agents"
              className="px-4 py-2.5 rounded-xl bg-(--blue) text-white font-bold text-xs shadow-md hover:bg-(--blue-dark) transition-colors duration-150 flex items-center gap-1.5"
            >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="p-5 rounded-2xl bg-(--surface) border border-(--border) shadow-xs space-y-2">
            ...
            <p className="text-3xl font-black text-(--text-primary)">2,480</p>
          ...
          <div className="p-5 rounded-2xl bg-(--surface) border border-(--border) shadow-xs space-y-2">
            ...
            <p className="text-3xl font-black text-(--blue)">ETB 1.48M</p>
            <p className="text-[11px] text-(--text-muted) font-medium">Locked in platform escrow</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link
            href="/admin/queue"
            className="p-6 rounded-2xl bg-(--surface) border border-(--border) shadow-xs hover:border-(--blue) transition-colors duration-150 group space-y-3"
          >
            <div className="w-10 h-10 rounded-xl bg-amber-500/10 text-amber-500 flex items-center justify-center">
              <HugeIcon name="shield" size={20} />
            </div>
            <h3 className="text-base font-bold text-(--text-primary) group-hover:text-(--blue)">
              Verification Queue →
            </h3>
            <p className="text-xs text-(--text-muted)">
